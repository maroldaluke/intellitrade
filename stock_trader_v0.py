...
def buyStock(app):
    app.paused = True
    currentPrice = app.stock[app.graphPeriod + app.startIndex][0]
    """
...
def clickedStartButton(app, x, y):
    centerLine = app.width * 3/4
    startButtonWidth = 80
    (startX1, startX2) = (centerLine - startButtonWidth, centerLine + startButtonWidth)
...
def drawStartingScreen(app, canvas):
   ...
   of the game is simple, make as much money 
    ...
    canvas.create_text(centerLine, startTextY, text = "START!", font = "Proxima 32 bold")    

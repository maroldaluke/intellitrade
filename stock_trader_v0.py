...
def redrawAll(app, canvas):
    ...
    if app.sma1On:
        drawSma(app, canvas, aapl_2008, 3, app.sma1Color)
    if app.sma2On:
        drawSma(app, canvas, aapl_2008, 8, app.sma2Color)
    if app.ema1On:
        drawEma(app, canvas, aapl_2008, 5, app.ema1Color)
    if app.ema2On:
        drawEma(app, canvas, aapl_2008, 9, app.ema2Color)
